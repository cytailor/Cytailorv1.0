...
class IndicesClient(NamespacedClient):
    ...
    async def add_block(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/index-modules-blocks.html>`_
    ...
    async def analyze(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-analyze.html>`_
    ...
    async def clear_cache(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-clearcache.html>`_
    ...
    async def clone(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-clone-index.html>`_
    ...
    async def close(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-open-close.html>`_
    ...
    async def create(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-create-index.html>`_
    ...
    async def create_data_stream(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/data-streams.html>`_
    ...
    async def delete(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-delete-index.html>`_
    ...
    async def delete_alias(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-aliases.html>`_
    ...
    async def delete_index_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-templates.html>`_
    ...
    async def disk_usage(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-disk-usage.html>`_
    ...
    async def exists(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-exists.html>`_
    ...
    async def field_usage_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/field-usage-stats.html>`_
    ...
    async def flush(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-flush.html>`_
    ...
    async def forcemerge(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-forcemerge.html>`_
    ...
    async def get(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-get-index.html>`_
    ...
    async def get_field_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-get-field-mapping.html>`_
    ...
    async def get_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-get-mapping.html>`_
    ...
    async def get_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-get-settings.html>`_
    ...
    async def put_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-put-mapping.html>`_
    ...
    async def put_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-update-settings.html>`_
    ...
    async def recovery(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-recovery.html>`_
    ...
    async def refresh(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-refresh.html>`_
    ...
    async def reload_search_analyzers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-reload-analyzers.html>`_
    ...
    async def resolve_index(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-resolve-index-api.html>`_
    ...
    async def rollover(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-rollover-index.html>`_
    ...
    async def segments(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-segments.html>`_
    ...
    async def shard_stores(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-shards-stores.html>`_
    ...
    async def shrink(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-shrink-index.html>`_
    ...
    async def split(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-split-index.html>`_
    ...
    async def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/indices-stats.html>`_
    ...
    async def unfreeze(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/unfreeze-index-api.html>`_
    ...
    async def validate_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/search-validate.html>`_
